...
const copy = {
  vi: {
    ...
    writingTitle: "Luyện viết local",
    speakingTitle: "Luyện nói với AI",
    listeningTitle: "Luyện nghe",
    readingTitle: "Luyện đọc",
    openExercise: "Mở bài luyện",
    completed: "Đã hoàn thành",
    localOnly: "Dữ liệu được lưu local trong PostgreSQL; chưa sử dụng AI hoặc cloud."
  },
  en: {
    ...
    writingTitle: "Local writing practice",
    speakingTitle: "AI speaking practice",
    listeningTitle: "Listening practice",
    readingTitle: "Reading practice",
    openExercise: "Open exercise",
    completed: "Completed",
    localOnly: "Data is stored locally in PostgreSQL; no AI or cloud is used."
  }
} as const;
