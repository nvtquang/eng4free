...
export type PublishedVocabularyCard = { id: string; headword: string; partOfSpeech: string | null; cefrLevel: string | null; ipa: string | null; meaning: string | null; example: string | null; tags: string[] };
